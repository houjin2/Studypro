...
UCLASS()
class STUDYPRO_API ASPlayerState : public APlayerState
{
	GENERATED_BODY()
...
public:
	...
	void SetCurrentTeamType(ETeamType InCurrentTeamtType) { CurrentTeamType = InCurrentTeamtType; }
...
private:
	UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category = "USPlayerState", Meta = (AllowPrivateAccess = true))
	...
	UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category = "USPlayerState", Meta = (AllowprivateAccess))
